        ...
        return (
            <main
                ...
                <section className={'p-10 w-10/12 md:w-3/6 lg:w-2/6 bg-white rounded-lg'} style={{maxWidth: '500px'}}>
                    <label htmlFor="userName" className="block mb-2 text-sm md:text-lg font-bold">퀴즈에 참여하는 분의 성함을 적어주세요 !️</label>
                    <input type="text" id="userName"
                           ...
                           placeholder="ex) 홍길동" required={true} minLength={1} maxLength={8}/>
                    <button
                        onClick={gameStart}
